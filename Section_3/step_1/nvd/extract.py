...
total_cves = 0
for year in years:
    input_file = f"nvd_cve_detail/linux_years/cve_data_{year}.json"  # Ensure the path is correct

    output_json = f"linux_year_cves/cve_patch_exploit_links_{year}.json"
    output_csv = f"linux_year_cves/cve_patch_exploit_links_{year}.csv"
