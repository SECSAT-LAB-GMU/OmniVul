...
if Key == "":
    print("You can get your API key from NVD website.")
    exit()
...
if __name__ == "__main__":
    ...
    for year in years:
        ...
        os.makedirs("nvd_cve_detail/linux_years/", exist_ok= True)
        year_cve_data = fetch_cve_by_year(year)
        if year_cve_data:
            with open(f"nvd_cve_detail/linux_years/cve_data_{year}.json", 'w') as file:
